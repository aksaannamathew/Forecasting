...
coca<-read_excel("C:\\Users\\91755\\Desktop\\Assignment\\forecasting\\CocaCola_Sales_Rawdata.xlsx")
head(coca)
str(coca)
...
cocacola<-cbind(coca,Q1,Q2,Q3,Q4)
View(cocacola)
colnames(cocacola)
...
plot(cocacola$Sales,type = "o",col="green")
